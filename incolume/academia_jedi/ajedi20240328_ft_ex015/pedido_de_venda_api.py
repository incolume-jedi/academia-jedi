...
def main(page: ft.Page):
    ...
    def pick_files_result(e: ft.FilePickerResultEvent):
        if e.files:
            file_paths = [file.path for file in e.files]  # Extrair caminhos dos arquivos
                ...
                ft.Container(
                    content=ft.ElevatedButton(
                                ...
                                style=ft.ButtonStyle(
                                    ...
                                    bgcolor={ft.MaterialState.FOCUSED: ft.colors.PINK_200, "": ft.colors.BLUE_300},
