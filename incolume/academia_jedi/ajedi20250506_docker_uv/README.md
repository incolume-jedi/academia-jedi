...
As diversas maneira para trabalhar com docker podem ser estudadas em https://docs.astral.sh/uv/guides/integration/docker.
Comandos e exemplos seguem na página.
