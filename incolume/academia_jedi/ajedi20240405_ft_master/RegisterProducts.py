...
# ruff: noqa: A002, ARG002, D101, D102, D107, E501, ERA001, N999, T201
...
# ruff: noqa: ARG002, A002, T201, ERA001, D101, D102, D107, E501
...
class RegisterProducts(UserControl):
    def __init__(self, route):
        ...
        self.btn_add_save_products = OutlinedButton(
            ...
            on_click=self.add_save_clicked,
        )
    ...
    def calc_margin(self, e):
        ...
        if not all(
            isinstance(value, float) for value in [cost, selling_price]
        ):
            return
    ...
    def analyze_fields(self, e):
        ...
        all_fields_filled = all(
            control.value != '' for control in required_fields
        )
        ...
        for control in required_fields:
            control.error_text = (
                '' if control.value != '' else 'Campo obrigatório'
            )
    ...
    def load_product(self, id):
        ...
        for index, control in enumerate([
            ...
            if index in [8, 9, 10]:
                control.value = Validator.format_to_currency(
                    float(control.value),
                )
        self.update()
