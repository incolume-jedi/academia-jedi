...
# ruff: noqa: ARG002, C901, D101, D102, D107, ERA001, N999
...
# ruff: noqa: ARG002, DTZ011, C901, ERA001, D101, D102, D107
...
class RegisterCustomer(UserControl):
    def __init__(self, route):
        ...
        self.dialog = AlertDialog(
            ...
            title=Row(
                expand=True,
                controls=[Text('Novo endereço:', expand=True, width=800)],
            ),
            actions=[
                Column(
                    controls=[
    ...
    def analyze_register_customer(self, e):
        ...
        if self.tf_name.value != '' and self.tf_CPF.value != '':
            if self.check_cpf_cnpj(e) is False:
                self.tf_CPF.error_text = 'CPF ou CNPJ inválido!'
                self.btn_add_save_customer.disabled = True
                self.update()
                return
