...
# ruff: noqa: A002, ARG002, C901, D101, D102, D107, DTZ005, DTZ007, E501, ERA001, N999, T201
...
# ruff: noqa: ARG002, A002, C901, T201, ERA001, D101, D102, D107, E501, DTZ005
...
class RegisterSales(UserControl):
    ...
    def load_card(self, data):
        ...
        self.tf_unit_price.data = Validator.format_to_currency(
            data[4],
        )  # unit_price
    ...
    def find_product(self, e):
        ...
        if self.sw_find.value:
            result = mydb.find_product_by_description(
    ...
    def calculate_fields(self, quantity, unit_price, discount, costs):
        ...
        self.tf_margin.value = f'{margin:.2f}'
        self.update()
    ...
    def delete_product(self, e):
        if (
            self.dt_products_sold.rows[e.control.data].cells[0].content.value
            != 'Aut.'
        ):
    ...
    def register_or_update_clicked(self, _):
        ...
        for row in range(len(self.dt_products_sold.rows)):
            ...
            if (
                self.dt_products_sold.rows[row].cells[0].content.value
                == 'Aut.'
            ):
    ...
    def register_sold_products(self, sale_id, products_data):
        ...
        Notification(
            self.page,
            f'Erro ao cadastrar/atualizar o pedido: {result[-1]}',
            'red',
        ).show_message()
