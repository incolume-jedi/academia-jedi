...
# ruff: noqa: ANN201, ARG002, C901, D101, D102, D107, E501, ERA001, N999, PERF401
...
# ruff: noqa: ARG002, C901, ANN201, ERA001, D101, D102, D107, E501
class Sales(UserControl):
    ...
    def select_sale_clicked(self, idsale):
        with contextlib.suppress(Exception):
            ...
            if data_sale and data_sold_products:
                ...
                Notification(
                    self.page,
                    'Erro ao carregar venda. Reinicie o sistema!',
                    'red',
                ).show_message()
                self.btn_print.disabled = True
            self.update()
    ...
    def edit_sale_clicked(self, e):
        ...
        self.route.register_sales.products_in_table = (
            self.get_all_sold_from_db(e.control.data)
        )
    ...
    def create_report_sales(self, e: FilePickerResultEvent):
        ...
        products_data.append([
            ...
            '',
            'Total:',
            Validator.format_to_currency(total),
        ])
        ...
        if result == 'success':
            Notification(
                self.route.page,
                f'Arquivo gerado com sucesso: {filename}',
                'green',
            ).show_message()
        else:
            Notification(
