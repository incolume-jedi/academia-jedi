...
def pg_chat():
    ...
    if 'messagens' not in st.session_state:
        st.session_state['messagens'] = MSG_FICT

    mensagens = st.session_state['messagens']
    userloged = 'Brito'
    ...
    if newmsg:
        ...
        st.session_state['messagens'] = mensagens
