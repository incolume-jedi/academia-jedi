...
**Contagem de vogais em página web**

Utilize os 4 primeiros paragrafos da URL https://pt.wikipedia.org/wiki/Python, e conte todas as vogais, ignorando caixa (maiusculo = minusculo)
