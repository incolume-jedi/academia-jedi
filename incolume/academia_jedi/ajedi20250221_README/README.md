...
Gerar README descritivo para todos os subprojetos.


## Resultado esperado

O que é esperado na conclusão deste ‘sprint’? Um README.md em todos os subprojetos com descrição de cada sprint individualmente.
